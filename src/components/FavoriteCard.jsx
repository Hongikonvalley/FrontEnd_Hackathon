...
const FavoriteCard = () => {
  ...
  return (
    <div className="flex flex-col p-[30px] border-primary border-2 bg-white shadow-md rounded-[20px] m-[20px]">
      <div className="flex flex-row items-center justify-between">
        <div>
          <div className="text-[20px] font-semibold">가비애</div>
          <div className="text-[30px] font-black text-secondary">n회 방문</div>
      ...
      <div className="flex flex-row items-center justify-end gap-[10px]">
        ...
        <button
          type="button"
          className="bg-primary rounded-[20px] h-[30px] w-1/2 text-[14px] text-white font-bold hover:cursor-pointer"
          onClick={() => nav('/')}
        >
          다시 얼리버드 되기
        </button>
